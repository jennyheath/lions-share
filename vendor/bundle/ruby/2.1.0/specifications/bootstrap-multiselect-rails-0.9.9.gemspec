...
Gem::Specification.new do |s|
  ...
  s.date = "2014-10-09"
  s.description = "Add Bootstrap Multiselect v0.9.9 to your rails app. See https://github.com/davidstutz/bootstrap-multiselect for more information about bootstrap-multiselect."
  s.email = ["canacb1@gmail.com"]
  s.homepage = "https://github.com/benjamincanac/bootstrap-multiselect-rails"
  s.licenses = ["MIT"]
  s.rubygems_version = "2.2.2"
  s.summary = "Add Bootstrap Multiselect v0.9.9 to your rails app."
