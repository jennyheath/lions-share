...
LionsShare.Views.ListingShow = Backbone.CompositeView.extend({
  ...
  addMap: function () {
    ...
    this.map = map;
    var map_pin_img = "/assets/map-pin-unselected-v2-8e9e4ca40b274a085275c466e932d932d50a35830caed2d9c05f4d322f3bac36.png";;
...
LionsShare.Views.RentalsIndexView = Backbone.CompositeView.extend({
  ...
  initialize: function (options) {
    ...
    view.listings.fetch({
      success: function () {
        // var num_results = 0;
        view.rentals = LionsShare.Collections.listings;
  ...
  addMapPins: function (rentals) {
    var rentals = this.rentals.models;
    ...
    _.forEach(rentals, function (listing) {
    ...
    this.markers.forEach(function (marker) {
      if ($listing.data('id') == marker.id) {
        ...
        if (view.halfOpacity === true) {
          var map_pin_img = "/assets/map-pin-half-v2-786098c77c8a5c8cae59a81864011fa2096b672ae88fdc2c2fa4a3eb8300601d.png";
        } else {
          var map_pin_img = "/assets/map-pin-selected-v2-3b6f958f9bcc926f3fe725169184f8c887037a159ef15a648502c7562b50fd0e.png";
        }
