...
// })();
(function() { this.JST || (this.JST = {}); this.JST["listings/broker_subview"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="single-agent">\n  <div class="broker-title">Contact Agent</div>\n  <img class="broker-modal-img" src="',  broker.photo_url ,'">\n  <div class="broker-modal-name">',  broker.first_name ,' ',  broker.last_name ,'</div>\n  <div class="broker-modal-phone">',  broker.phone ,'</div>\n  <div class="broker-modal-email">',  broker.email ,'</div>\n  <div class="message-box">\n    <p>Message</p>\n    <form action="//formspree.io/',  broker.email ,'" method="POST">\n      <input class="return-email"\n             type="email"\n             name="_replyto"\n             placeholder="Your email address">\n      <input type="hidden" name="_cc" value="lionshareinc@gmail.com" />\n      <textarea class="email-message"\n                name="message"\n                placeholder="Hello, I would like to schedule a time to view this apartment. Thanks."\n                rows="6"></textarea>\n      <input type="hidden" name="_next" value="//lions-share.herokuapp.com/#listings/',  listing.id ,'/emailConfirmation" />\n      <input class="submit-email" type="submit" value="Send">\n    </form>\n  </div>\n  <div class="see-broker-list">Contact a different agent</div>\n  <div class="clear"></div>\n</div>\n<div class="all-agents hide">\n  <div class="broker-title">Choose an Agent</div>\n  <div class="broker-modal-list">\n    ');  var brokerList = listing.get('all_brokers') ; __p.push('\n    ');  brokerList.forEach(function (broker) { ; __p.push('\n      <div class="choose-broker">\n        <img class="broker-modal-img broker-list-img" src="',  broker.photo_url ,'">\n        <div class="broker-modal-name broker-list-name">\n          ',  broker.first_name ,' ',  broker.last_name ,'\n        </div>\n        <img class="checkmark" src="assets/check.png">\n        <div class="clear"></div>\n      </div>\n    ');  }) ; __p.push('\n  </div>\n  <div class="select-agent-container">\n    <div class="select-agent">Select Agent</div>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["listings/listing_show"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="listing-show-container">\n  <div class="row listing-details-container">\n    <div class="listing-img-container group col-xs-10 col-sm-6 col-md-6 col-lg-6">\n      <img class="listing-main-img" src="',  listing.escape('main_photo_url') ,'">\n    </div>\n    <div class="listing-show-info group col-xs-10 col-sm-6 col-md-6 col-lg-6">\n      ');  function commaSeparateNumber(val){ ; __p.push('\n        ');  while (/(\d+)(\d{3})/.test(val.toString())){ ; __p.push('\n          ');  val = val.toString().replace(/(\d+)(\d{3})/, '$1'+','+'$2'); ; __p.push('\n        ');  } ; __p.push('\n        ');  return val; ; __p.push('\n      ');  } ; __p.push('\n      <h1 class="listing-price">$',  commaSeparateNumber(listing.escape('price')) ,'</h1>\n      <div class="bed-bath-neighborhood">\n        <h2 class="listing-beds">\n          ');  if (listing.escape('bed_count') > 0 && listing.escape('bed_count') < 4) { ; __p.push('\n            ',  listing.escape('bed_count') ,' Bed</h2>\n          ');  } else if (listing.escape('bed_count') == 0) { ; __p.push('\n            Studio\n          ');  } else if (listing.escape('bed_count') == 4) { ; __p.push('\n            4+ Bed\n          ');  } ; __p.push('\n        <h2 class="listing-baths">',  listing.escape('bath_count') ,' Bath</h2>\n        ');  if (listing.escape('type_of') == "Sale") { ; __p.push('\n          <div class="listing-buildingtype">',  listing.escape('building_type') ,'</div>\n        ');  } ; __p.push('\n        <h2 class="listing-neighborhood">',  listing.escape('neighborhood') ,'</h2>\n      </div>\n      <p class="listing-description">',  listing.escape('description') ,'</p>\n      <div class="lot-info">Sq Ft: ',  commaSeparateNumber(listing.escape('square_footage')) ,' sqft</div>\n      ');  if (listing.escape('type_of') == "Sale") { ; __p.push('\n        <div class="lot-info">Yearly Taxes: $',  commaSeparateNumber(listing.escape('yearly_taxes')) ,'</div>\n      ');  } ; __p.push('\n      <div class="lot-info">Lot Sq Ft: ',  commaSeparateNumber(listing.escape('square_footage')) ,' sqft</div>\n      ');  if (listing.escape('floor_plan_url')) { ; __p.push('\n        <div class="lot-info floor-plan">Floorplan</div>\n      ');  } ; __p.push('\n      <ul class="listing-amenities">\n        ');  var amenities = listing.get('amenities') ; __p.push('\n        ');  var unique = [] ; __p.push('\n        ');  amenities.forEach(function (amenity) { ; __p.push('\n          ');  var name = amenity.name ; __p.push('\n          ');  if (unique.indexOf(amenity.name) === -1) { ; __p.push('\n            ');  unique.push(name) ; __p.push('\n          ');  } ; __p.push('\n        ');   }) ; __p.push('\n        ');  unique.forEach(function (amenity) { ; __p.push('\n          <li>',  amenity ,'</li>\n        ');  }) ; __p.push('\n      </ul>\n      <div class="broker-box">\n        ');  var first_broker = listing.get('brokers')[0] ; __p.push('\n        <img class="broker-box-img" src="',  first_broker.photo_url ,'">\n        <div class="broker-info">\n          Listed by <br>\n          <div class="broker-name">\n            ',  first_broker.first_name ,' ',  first_broker.last_name ,'\n          </div>\n        </div>\n        <button class="contact-button">Contact</button>\n      </div>\n    </div>\n  </div>\n  <div class="clear"></div>\n\n  <div class="listing-photos">\n    <div class="photos-title">Photos</div>\n    ');  var photos = listing.get('photos') ; __p.push('\n    ');  for (i = 0; i < 2; i++) { ; __p.push('\n      <div class="listing-photo-container col-xs-6 col-sm-6 col-md-6 col-lg-6">\n        ');  if (photos[i]) { ; __p.push('\n          <img class="listing-photo" src="',  photos[i].url ,'">\n        ');  } ; __p.push('\n      </div>\n    ');  } ; __p.push('\n    ');  for (i = 2; i < 5; i++) { ; __p.push('\n      <div class="listing-photo-container col-xs-4 col-sm-4 col-md-4 col-lg-4">\n        ');  if (photos[i]) { ; __p.push('\n          <img class="listing-photo" src="',  photos[i].url ,'">\n        ');  } ; __p.push('\n      </div>\n    ');  } ; __p.push('\n    ');  if (photos.length > 5) { ; __p.push('\n      <div class="view-all">\n        <button class="view-photos-button">View All</button>\n      </div>\n      <div class="hidden-photos">\n        ');  for (i = 5; i < photos.length; i++) { ; __p.push('\n          <div class="listing-photo-container col-xs-4 col-sm-4 col-md-4 col-lg-4">\n            <img class="listing-photo" src="',  photos[i].url ,'">\n          </div>\n        ');  } ; __p.push('\n      </div>\n    ');  } ; __p.push('\n    <div class="clear"></div>\n  </div>\n\n  <div class="map-container">\n      <div id="subway-map"></div>\n      <div class="clear"></div>\n  </div>\n\n  <div class="listing-footer">\n    <div class="footer-top">\n      <div class="footer-logo col-xs-10 col-sm-6 col-md-6 col-lg-6">\n        <img class="footer-logo-img" src="assets/logo_dark_background.png">\n      </div>\n      <div class="footer-address col-xs-10 col-sm-6 col-md-6 col-lg-6">\n        <div class="address-title">Location</div>\n        115 S Oxford Street<br>\n        Brooklyn, New York 11217<br>\n        917.909.0526\n      </div>\n      <div class="clear"></div>\n    </div>\n    <div class="footer-bottom">\n      <div class="footer-icons col-xs-10 col-sm-6 col-md-6 col-lg-6">\n        <a class="terms-link" href="#">Terms & Conditions and Privacy Policy</a>\n      </div>\n      <div class="footer-terms col-xs-10 col-sm-6 col-md-6 col-lg-6">\n        <p class="terms-copyright">&#169; The Lion\'s Share, Inc. All Rights Reserved. 2015</p>\n      </div>\n      <div class="clear"></div>\n    </div>\n    <div class="clear"></div>\n  </div>\n</div>\n\n<div class="modal fade" id="brokerModal" tabindex="-1" role="dialog" aria-labelledby="brokerModalLabel">\n  <div class="modal-dialog broker-modal-dialog" role="document">\n    <div class="modal-content">\n      <div class="modal-body">\n        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>\n        <div class="broker-contact-info"></div>\n      </div>\n    </div>\n  </div>\n</div>\n\n<div class="modal fade" id="floorplanModal" tabindex="-1" role="dialog" aria-labelledby="brokerModalLabel">\n  <button type="button" class="close close-floorplan" data-dismiss="modal" aria-label="Close">\n    <span aria-hidden="true">&times;</span>\n  </button>\n  <div class="modal-dialog floorplan-modal-dialog" role="document">\n    <div class="modal-content">\n      <div class="modal-body">\n        <img class="floor-plan-img" src="',  listing.escape('floor_plan_url') ,'">\n        <div class="clear"></div>\n      </div>\n    </div>\n  </div>\n</div>\n\n<div class="modal fade" id="confirmationModal" tabindex="-1" role="dialog" aria-labelledby="confirmationModalLabel">\n  <div class="modal-dialog confirmation-modal-dialog" role="document">\n    <div class="modal-content">\n      <div class="modal-body">\n        <div class="row"><div class="check-column col-lg-3 col-md-3 col-sm-3 col-xs-3">\n          <img class="confirmation-img" src="assets/confirmation_checkmark.png">\n        </div></div>\n        <h2 class="sent-message-title">Message Sent!</h2>\n        <p class="sent-message-text">A reply will be sent to the email address you provided as soon as possible!</p>\n          <button class="closeConfirmation" type="button" data-dismiss="modal" aria-label="Close">\n            Close\n          </button>\n      </div>\n    </div>\n  </div>\n</div>\n\n<script>\n  $(\'.closeConfirmation\').on(\'click\', function () {\n    window.setTimeout(function () {\n      window.location.replace(\'#listings/',  listing.id ,'\');\n    }, 1000);\n  });\n  $(\'#brokerModal\').on(\'shown.bs.modal\', function () {\n    $(\'#myInput\').focus();\n  });\n\n  if (matchMedia) {\n    var mq = window.matchMedia("(min-width: 500px)");\n    mq.addListener(WidthChange);\n    WidthChange(mq);\n  }\n\n  // media query change\n  function WidthChange(mq) {\n    window.removeEventListener(WidthChange);\n    if (mq.matches) {\n      $(\'.mobile-browse-footer\').removeClass(\'mobile-browse-footer\');\n    }\n    else {\n      $(\'.listing-footer\').addClass(\'mobile-browse-footer\');\n    }\n  }\n  jQuery(document).ready(function() {\n    jQuery("abbr.timeago").timeago();\n  });\n</script>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["listings/listing_subview"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="listing-subview col-xs-12 col-sm-6 col-md-6 col-lg-6">\n  <a href="#listings/',  listing.id ,'">\n    <div class="individual-listing-container" data-id="',  listing.id ,'">\n    <div class="listing-container-hover"></div>\n      <div class="photo-wrapper">\n        ');  if (listing.exclusive == true && listing.no_fee == true) { ; __p.push('\n          <div class="photo-tags">\n            <p class="exclusive-tag">Exclusive</p>\n            <p class="no-fee-tag">No Fee</p>\n          </div>\n        ');  } ; __p.push('\n        ');  if (listing.exclusive == true && listing.no_fee !== true) { ; __p.push('\n            <div class="exclusive-tag">Exclusive</div>\n        ');  } ; __p.push('\n        ');  if (listing.no_fee == true && listing.exclusive !== true) { ; __p.push('\n            <div class="no-fee-tag">No Fee</div>\n        ');  } ; __p.push('\n        <a href="#listings/',  listing.id ,'">\n        <img class="main-img" src="',  listing.main_photo_url ,'">\n        </a>\n      </div>\n      <div class="info-wrapper row">\n        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 price-wrapper">\n          ');  var priceString = [] ; __p.push('\n          ');  var letters = listing.price.toString().split('') ; __p.push('\n          ');  while (letters.length > 3) { ; __p.push('\n            ');  priceString.push(letters.pop()) ; __p.push('\n            ');  priceString.push(letters.pop()) ; __p.push('\n            ');  priceString.push(letters.pop()) ; __p.push('\n            ');  priceString.push(',') ; __p.push('\n          ');  } ; __p.push('\n          ');  letters.reverse().forEach(function (letter) { ; __p.push('\n            ');  priceString.push(letter) ; __p.push('\n          ');   }) ; __p.push('\n          <h2>$',   priceString.reverse().join('') ,'</h2>\n        </div>\n        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 bed-bath-wrapper">\n          <p class="info-details">\n            ');  if (listing.bed_count > 0 && listing.bed_count < 4) { ; __p.push('\n              ',  listing.bed_count ,' Bed\n            ');  } else if (listing.bed_count === 0) { ; __p.push('\n              Studio\n            ');  } else if (listing.bed_count === 4) { ; __p.push('\n              4+ Bed\n            ');  } ; __p.push('\n            ',  listing.bath_count ,' Bath </p>\n          <p class="info-details">',  listing.neighborhood ,'</p>\n        </div>\n      </div>\n    </div>\n  </a>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["listings/rentals_index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="container-fluid filter-page-container">\n  <div class="row index-sorting filter-wrapper">\n    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">\n      <div class="all-filters row">\n          <div class="neighborhood-filter filter-dropdown col-xs-5 col-sm-5 col-md-5 col-lg-5">\n            <!-- <div class="dropdown-container"></div> -->\n            <div class="stay-open dropdown form-control filterby by_neighborhood">\n              <div class="stay-open toggle-dropdown">Select Neighborhoods <span class="stay-open caret"></span></div>\n              <div class="stay-open dropdown-menu">\n                <ul class="stay-open filter-list neighborhoods-column">\n                  ');  var firstListing; ; __p.push('\n                  ');  if (listings.first()) { ; __p.push('\n                    ');  firstListing = listings.first(); ; __p.push('\n                  ');  } else { ; __p.push('\n                    ');  firstListing = { attributes: { neighborhoods: [], beds: 0 }}; ; __p.push('\n                  ');  } ; __p.push('\n                  ');  firstListing.attributes.neighborhoods.forEach(function (neighborhood) { ; __p.push('\n                    <li class="stay-open" id="',  neighborhood ,'">\n                      <input class="stay-open neighborhood-checkbox" type="checkbox">\n                      <div class="stay-open filter-category">\n                        ',  neighborhood ,'\n                      </div>\n                    </li>\n                  ');  }) ; __p.push('\n                </ul>\n              </div>\n            </div>\n          </div>\n          <div class="bed-filter filter-dropdown col-xs-2 col-sm-2 col-md-2 col-lg-2">\n            <div class="stay-open dropdown form-control filterby by_bed">\n              <div class="stay-open toggle-dropdown">Beds <span class="stay-open caret"></span></div>\n              <div class="stay-open dropdown-menu">\n                <ul class="stay-open filter-list beds-column">\n                  <li class="stay-open" id="0">\n                    <input class="stay-open bed-checkbox" type="checkbox">\n                    <div class="stay-open filter-category">\n                      Studio\n                    </div>\n                  </li>\n                  ');  firstListing.attributes.beds.forEach(function (bed_num) { ; __p.push('\n                    ');  if (bed_num !== 0 && bed_num !== 4) { ; __p.push('\n                      <li class="stay-open" id="',  bed_num ,'">\n                        <input class="stay-open bed-checkbox" type="checkbox">\n                        <div class="stay-open filter-category">\n                          ',  bed_num ,' Bedroom\n                        </div>\n                      </li>\n                    ');  } ; __p.push('\n                  ');  }) ; __p.push('\n                  <li class="stay-open" id="4">\n                    <input class="stay-open bed-checkbox" type="checkbox">\n                    <div class="stay-open filter-category">\n                      4+ Bedroom\n                    </div>\n                  </li>\n                </ul>\n              </div>\n            </div>\n          </div>\n          <div class="price-filter filter-dropdown col-xs-2 col-sm-2 col-md-2 col-lg-2">\n            <div class="stay-open dropdown form-control filterby by_price">\n              <div class="stay-open toggle-dropdown">Price <span class="stay-open caret"></span></div>\n                <div class="stay-open dropdown-menu price-dropdown">\n                  <input class="stay-open price-min" type="text" placeholder="Minimum">\n                  to\n                  <input class="stay-open price-max" type="text" placeholder="Maximum">\n                  <input class="stay-open fee-box" type="checkbox">No Fee\n                </div>\n            </div>\n            </div>\n          <div class="amenity-filter filter-dropdown col-xs-4 col-sm-4 col-md-4 col-lg-4">\n            <div class="stay-open dropdown form-control filterby by_amenity">\n              <div class="stay-open toggle-dropdown">More <span class="stay-open caret"></span></div>\n              <div class="stay-open dropdown-menu">\n                <ul class="stay-open filter-list amenities-column">\n                  ');  listings.first().attributes.amenities.forEach(function (amenity) { ; __p.push('\n                    <li class="stay-open" id="',  amenity ,'">\n                      <input class="stay-open amenity-checkbox" type="checkbox">\n                      <div class="stay-open filter-category">\n                        ',  amenity ,'\n                      </div>\n                    </li>\n                  ');  }) ; __p.push('\n                </ul>\n              </div>\n            </div>\n          </div>\n      </div>\n    </div>\n    <div class="show-other-filters">\n      <p class="plus-sign">+</p>\n    </div>\n    <div class="clear"></div>\n  </div>\n</div>\n    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4 clear-all-container">Clear All</div>\n<div class="row content-wrapper">\n  <div class="col-sm-7 col-md-7 col-lg-7 sort-matches-container">\n    <div class="row index-sorting sort-wrapper">\n        <ul class="sort-by col-xs-10 col-sm-6 col-md-6 col-lg-6">\n        <li class= "sort-label">Sort By</li>\n        <div class="sort-by-buttons">\n          <li class="sort-by-border price-sort">Price</li>\n          <li class="sort-by-border newest-sort">Newest</li>\n        </div>\n      </ul>\n      <div class="results-found col-xs-6 col-sm-6 col-md-6 col-lg-6">\n        <div class="num-results"></div><div class="results"> results found</div>\n      </div>\n    </div>\n    <div class="row matches-wrapper">\n    </div>\n  </div>\n  <div class="col-sm-5 col-md-5 col-lg-5 map-wrapper">\n    <div id="map-canvas"></div>\n  </div>\n</div>\n\n<script>\n  // media query event handler\n  if (matchMedia) {\n    var mq = window.matchMedia("(min-width: 500px)");\n    mq.addListener(WidthChange);\n    WidthChange(mq);\n  }\n\n  $(document).ready(function () {\n    if (window.matchMedia("(min-width: 500px)").matches) {\n      // debugger;\n    } else {\n      $(\'.bed-filter\').addClass(\'hide-filter\');\n      $(\'.price-filter\').addClass(\'hide-filter\');\n      $(\'.amenity-filter\').addClass(\'hide-filter\');\n    }\n  });\n\n  // media query change\n  function WidthChange(mq) {\n    window.removeEventListener(WidthChange);\n    if (mq.matches) {\n      $(\'.bed-filter\').addClass(\'hide-filter\');\n      $(\'.price-filter\').addClass(\'hide-filter\');\n      $(\'.amenity-filter\').addClass(\'hide-filter\');\n    }\n    else {\n    }\n  }\n\n  $(\'.show-other-filters\').on(\'click\', function () {\n    $(\'.show-other-filters\').css(\'display\', \'none\');\n    $(\'.plus-sign\').css(\'display\', \'none\');\n\n    $(\'.bed-filter\').removeClass(\'hide-filter\');\n    $(\'.price-filter\').removeClass(\'hide-filter\');\n    $(\'.amenity-filter\').removeClass(\'hide-filter\');\n  })\n</script>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["listings/sales_index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="container-fluid filter-page-container">\n  <div class="row index-sorting filter-wrapper">\n    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">\n      <div class="all-filters row">\n          <div class="neighborhood-filter filter-dropdown col-xs-5 col-sm-5 col-md-5 col-lg-5">\n            <!-- <div class="dropdown-container"></div> -->\n            <div class="stay-open dropdown form-control filterby by_neighborhood">\n              <div class="stay-open toggle-dropdown">Select Neighborhoods <span class="stay-open caret"></span></div>\n              <div class="stay-open dropdown-menu">\n                <ul class="stay-open filter-list neighborhoods-column">\n                  ');  var firstListing; ; __p.push('\n                  ');  if (listings.first()) { ; __p.push('\n                    ');  firstListing = listings.first(); ; __p.push('\n                  ');  } else { ; __p.push('\n                    ');  firstListing = { attributes: { neighborhoods: [], beds: 0, building_types: [], amenities: [] }}; ; __p.push('\n                  ');  } ; __p.push('\n                  ');  firstListing.attributes.neighborhoods.forEach(function (neighborhood) { ; __p.push('\n                    <li class="stay-open">\n                      <input class="stay-open neighborhood-checkbox" type="checkbox">\n                      <div class="stay-open filter-category">',  neighborhood ,'</div>\n                    </li>\n                  ');  }) ; __p.push('\n                </ul>\n              </div>\n            </div>\n          </div>\n          <div class="bed-filter filter-dropdown col-xs-2 col-sm-2 col-md-2 col-lg-2">\n            <div class="stay-open dropdown form-control filterby by_bed">\n              <div class="stay-open toggle-dropdown">Beds <span class="stay-open caret"></span></div>\n              <div class="stay-open dropdown-menu">\n                <ul class="stay-open filter-list beds-column">\n                  <li class="stay-open" id="0">\n                    <input class="stay-open bed-checkbox" type="checkbox">\n                    <div class="stay-open filter-category">\n                      Studio\n                    </div>\n                  </li>\n                  ');  firstListing.attributes.beds.forEach(function (bed_num) { ; __p.push('\n                    ');  if (bed_num !== 0 && bed_num !== 4) { ; __p.push('\n                      <li class="stay-open" id="',  bed_num ,'">\n                        <input class="stay-open bed-checkbox" type="checkbox">\n                        <div class="stay-open filter-category">\n                          ',  bed_num ,' Bedroom\n                        </div>\n                      </li>\n                    ');  } ; __p.push('\n                  ');  }) ; __p.push('\n                  <li class="stay-open" id="4">\n                    <input class="stay-open bed-checkbox" type="checkbox">\n                    <div class="stay-open filter-category">\n                      4+ Bedroom\n                    </div>\n                  </li>\n                </ul>\n              </div>\n            </div>\n          </div>\n          <div class="price-filter filter-dropdown col-xs-2 col-sm-2 col-md-2 col-lg-2">\n            <div class="stay-open dropdown form-control filterby by_price">\n              <div class="stay-open toggle-dropdown">Price <span class="stay-open caret"></span></div>\n                <div class="stay-open dropdown-menu price-dropdown">\n                  <input class="stay-open price-min" type="text" placeholder="Minimum">\n                  to\n                  <input class="stay-open price-max" type="text" placeholder="Maximum">\n                  <input class="stay-open fee-box" type="checkbox">No Fee\n                </div>\n            </div>\n          </div>\n          <div class="building-type-filter filter-dropdown col-xs-5 col-sm-5 col-md-5 col-lg-5">\n            <div class="stay-open dropdown form-control filterby by_building_type">\n              <div class="stay-open toggle-dropdown">Building Type <span class="stay-open caret"></span></div>\n              <div class="stay-open dropdown-menu">\n                <ul class="stay-open filter-list building-type-column">\n                  ');  firstListing.attributes.building_types.forEach(function (building_type) { ; __p.push('\n                    <li class="stay-open">\n                      <input class="stay-open building-checkbox" type="checkbox">\n                      <div class="stay-open filter-category">',  building_type ,'</div>\n                    </li>\n                  ');  }) ; __p.push('\n                </ul>\n              </div>\n            </div>\n          </div>\n          <div class="amenity-filter filter-dropdown col-xs-4 col-sm-4 col-md-4 col-lg-4">\n            <div class="stay-open dropdown form-control filterby by_amenity">\n              <div class="stay-open toggle-dropdown">More <span class="stay-open caret"></span></div>\n              <div class="stay-open dropdown-menu">\n                <ul class="stay-open filter-list amenities-column">\n                  ');  firstListing.attributes.amenities.forEach(function (amenity) { ; __p.push('\n                    <li class="stay-open">\n                      <input class="stay-open amenity-checkbox" type="checkbox">\n                      <div class="stay-open filter-category">',  amenity ,'</div>\n                    </li>\n                  ');  }) ; __p.push('\n                </ul>\n              </div>\n            </div>\n            </div>\n          </div>\n        </div>\n        <div class="show-other-filters">\n          <p class="plus-sign">+</p>\n        </div>\n        <div class="clear"></div>\n      </div>\n    </div>\n    <div class="col-xs-2 col-sm-2 col-md-2 col-lg-2 clear-all-container">Clear All</div>\n\n<div class="row content-wrapper">\n  <div class="col-sm-7 col-md-7 col-lg-7 sort-matches-container">\n    <div class="row index-sorting sort-wrapper">\n        <ul class="sort-by col-xs-10 col-sm-6 col-md-6 col-lg-6">\n        <li class= "sort-label">Sort By</li>\n        <div class="sort-by-buttons">\n          <li class="sort-by-border price-sort">Price</li>\n          <li class="sort-by-border newest-sort">Newest</li>\n        </div>\n      </ul>\n      <div class="results-found col-xs-6 col-sm-6 col-md-6 col-lg-6">\n        <div class="num-results"></div><div class="results"> results found</div>\n      </div>\n    </div>\n    <div class="row matches-wrapper">\n    </div>\n  </div>\n  <div class="col-sm-5 col-md-5 col-lg-5 map-wrapper">\n    <div id="map-canvas"></div>\n  </div>\n</div>\n\n<script>\n  // media query event handler\n  if (matchMedia) {\n    var mq = window.matchMedia("(min-width: 500px)");\n    mq.addListener(WidthChange);\n    WidthChange(mq);\n  }\n\n  $(document).ready(function () {\n    if (window.matchMedia("(min-width: 500px)").matches) {\n      // debugger;\n    } else {\n      $(\'.bed-filter\').addClass(\'hide-filter\');\n      $(\'.price-filter\').addClass(\'hide-filter\');\n      $(\'.amenity-filter\').addClass(\'hide-filter\');\n      $(\'.building-type-filter\').addClass(\'hide-filter\');\n    }\n  });\n\n  // media query change\n  function WidthChange(mq) {\n    window.removeEventListener(WidthChange);\n    if (mq.matches) {\n      $(\'.bed-filter\').addClass(\'hide-filter\');\n      $(\'.price-filter\').addClass(\'hide-filter\');\n      $(\'.amenity-filter\').addClass(\'hide-filter\');\n      $(\'.building-type-filter\').addClass(\'hide-filter\');\n    }\n    else {\n    }\n  }\n\n  $(\'.show-other-filters\').on(\'click\', function () {\n    $(\'.show-other-filters\').css(\'display\', \'none\');\n    $(\'.plus-sign\').css(\'display\', \'none\');\n\n    $(\'.bed-filter\').removeClass(\'hide-filter\');\n    $(\'.price-filter\').removeClass(\'hide-filter\');\n    $(\'.amenity-filter\').removeClass(\'hide-filter\');\n    $(\'.building-type-filter\').removeClass(\'hide-filter\');\n  })\n</script>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["root/about_us"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="about-container row">\n  <div class="about-left-col col-xs-7 col-sm-7 col-md-7 col-lg-7">\n    <h1 class="about-title">We know Brooklyn, <br>inside and out.</h1>\n    <p class="about-info">The Lion\'s Share, Inc. is a celebrated real estate firm and licensed\n      brokerage located in Brooklyn, New York. Our team of experienced\n      agents cover sales and rentals throughout the borough. We\n      specialize in the neighborhoods of Fort Greene, Clinton Hill,\n      Bed-Stuy, Crown Heights, Prospect Park, Park Slope, Cobble Hill,\n      and Carrol Gardens.\n      <br><br>\n      For more information, please fill the following form and we will get\n      back to you shortly.</p>\n\n    <div class="dropdown email-dropdown">Subject <span class="about-caret caret"></span>\n      <ul class="email-menu dropdown-menu">\n        <li class="subject-item">Rental Inquiry</li>\n        <li class="subject-item">Sales</li>\n        <li class="subject-item">Career Opportunities</li>\n        <li class="subject-item">Other</li>\n      </ul>\n    </div>\n\n    <p class="about-email about-email-title">Message</p>\n    <form class="about-email" action="//formspree.io/lionshareinc@gmail.com" method="POST">\n      <input class="about-subject" type="hidden" name="_subject" value="No subject" />\n      <input class="return-email about-form"\n             type="email"\n             name="_replyto"\n             placeholder="Your email address">\n      <textarea class="email-message about-form"\n                name="message"\n                placeholder="Your message"\n                rows="6"></textarea>\n      <input type="hidden" name="_next" value="//lions-share.herokuapp.com/#about_us/emailConfirmation" />\n      <input class="submit-email about-submit about-form" type="submit" value="Send Message">\n    </form>\n  </div>\n  <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3">\n    <img class="lion-icon" src="assets/lion_icon.png">\n    <div class="about-subheader">Contact Information</div>\n    <div class="about-contact-info">P: 917 909 0526</div>\n    <div class="about-contact-info">F: 212 663 0329</div>\n    <div class="about-subheader">Office</div>\n    <div class="about-contact-info">115 S Oxford St</div>\n    <div class="about-contact-info">Brooklyn, New York 11217</div>\n    <div class="about-subheader">Career Opportunities</div>\n    <div class="about-contact-info about-email">\n      <a href="mailto:lionshareinc@gmail.com">lionshareinc@gmail.com</a>\n    </div>\n  </div>\n</div>\n\n<div class="listing-footer">\n  <div class="footer-top">\n    <div class="footer-logo col-xs-10 col-sm-6 col-md-6 col-lg-6">\n      <img class="footer-logo-img" src="assets/logo_dark_background.png">\n    </div>\n    <div class="footer-address col-xs-10 col-sm-6 col-md-6 col-lg-6">\n      <div class="address-title">Location</div>\n      115 S Oxford Street<br>\n      Brooklyn, New York 11217<br>\n      917.909.0526\n    </div>\n    <div class="clear"></div>\n  </div>\n  <div class="footer-bottom">\n  <div class="footer-icons col-xs-10 col-sm-6 col-md-6 col-lg-6">\n    <a class="terms-link" href="#">Terms & Conditions and Privacy Policy</a>\n  </div>\n  <div class="footer-terms col-xs-10 col-sm-6 col-md-6 col-lg-6">\n    <p class="terms-copyright">&#169; The Lion\'s Share, Inc. All Rights Reserved. 2015</p>\n  </div>\n  <div class="clear"></div>\n  </div>\n  <div class="clear"></div>\n</div>\n\n<div class="modal fade" id="confirmationModal" tabindex="-1" role="dialog" aria-labelledby="confirmationModalLabel">\n  <div class="modal-dialog confirmation-modal-dialog" role="document">\n    <div class="modal-content">\n      <div class="modal-body">\n        <div class="row"><div class="check-column col-lg-3 col-md-3 col-sm-3 col-xs-3">\n          <img class="confirmation-img" src="assets/confirmation_checkmark.png">\n        </div></div>\n        <h2 class="sent-message-title">Message Sent!</h2>\n        <p class="sent-message-text">A reply will be sent to the email address you provided as soon as possible!</p>\n          <button class="closeConfirmation" type="button" data-dismiss="modal" aria-label="Close">\n            Close\n          </button>\n      </div>\n    </div>\n  </div>\n</div>\n\n<script>\n  dropdownListener = function () {\n  $(\'.email-dropdown\').on(\'click\', function () {\n    if ($(\'.email-menu\').hasClass(\'open\')) {\n      $(\'.email-menu\').removeClass(\'open\');\n      $(\'.about-caret\').removeClass(\'about-caret-reversed\');\n    } else {\n      $(\'.email-menu\').addClass(\'open\');\n      $(\'.about-caret\').addClass(\'about-caret-reversed\');\n    }\n  });\n  }\n\n  changeTitleListener = function () {\n  $(\'.subject-item\').on(\'click\', function (event) {\n    event.stopPropagation();\n    var subject = $(event.target).text();\n    $(\'.about-subject\').val(subject);\n\n    var clone = $(\'.email-dropdown\').clone();\n    var children = clone.children().remove();\n    clone.text(subject);\n    clone.append(children);\n    $(\'.email-dropdown\').replaceWith(clone);\n\n    $(\'.email-menu\').removeClass(\'open\');\n    $(\'.about-caret\').removeClass(\'about-caret-reversed\');\n    dropdownListener();\n    changeTitleListener();\n  });\n  }\n\n  dropdownListener();\n  changeTitleListener();\n</script>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["root/broker_listing_subview"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="listing-subview col-xs-12 col-sm-4 col-md-4 col-lg-4">\n  <a href="#listings/',  listing.id ,'">\n    <div class="individual-listing-container" data-id="',  listing.id ,'">\n    <div class="listing-container-hover"></div>\n      <div class="photo-wrapper">\n        ');  if (listing.exclusive == true && listing.no_fee == true) { ; __p.push('\n          <div class="photo-tags">\n            <p class="exclusive-tag">Exclusive</p>\n            <p class="no-fee-tag">No Fee</p>\n          </div>\n        ');  } ; __p.push('\n        ');  if (listing.exclusive == true && listing.no_fee !== true) { ; __p.push('\n            <div class="exclusive-tag">Exclusive</div>\n        ');  } ; __p.push('\n        ');  if (listing.no_fee == true && listing.exclusive !== true) { ; __p.push('\n            <div class="no-fee-tag">No Fee</div>\n        ');  } ; __p.push('\n        <a href="#listings/',  listing.id ,'">\n        <img class="main-img" src="',  listing.main_photo_url ,'">\n        </a>\n      </div>\n      <div class="info-wrapper row">\n        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 price-wrapper">\n          ');  var priceString = [] ; __p.push('\n          ');  var letters = listing.price.toString().split('') ; __p.push('\n          ');  while (letters.length > 3) { ; __p.push('\n            ');  priceString.push(letters.pop()) ; __p.push('\n            ');  priceString.push(letters.pop()) ; __p.push('\n            ');  priceString.push(letters.pop()) ; __p.push('\n            ');  priceString.push(',') ; __p.push('\n          ');  } ; __p.push('\n          ');  letters.reverse().forEach(function (letter) { ; __p.push('\n            ');  priceString.push(letter) ; __p.push('\n          ');   }) ; __p.push('\n          <h2>$',   priceString.reverse().join('') ,'</h2>\n        </div>\n        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 bed-bath-wrapper">\n          <p class="info-details">\n            ');  if (listing.bed_count > 0 && listing.bed_count < 4) { ; __p.push('\n              ',  listing.bed_count ,' Bed\n            ');  } else if (listing.bed_count === 0) { ; __p.push('\n              Studio\n            ');  } else if (listing.bed_count === 4) { ; __p.push('\n              4+ Bed\n            ');  } ; __p.push('\n            ',  listing.bath_count ,' Bath </p>\n          <p class="info-details">',  listing.neighborhood ,'</p>\n        </div>\n      </div>\n    </div>\n  </a>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["root/broker_profile_subview"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<a href="#brokers/',  broker.id,'">\n\t<img class="team-img" src=', broker.photo_url,'>\n\t<div class="team-name">',  broker.first_name ,' ',  broker.last_name ,'</div>\n\t<div class="team-phone">',  broker.phone ,'</div>\n\t<a href="mailto:',  broker.email ,'">\n\t\t<div class="team-email">',  broker.email ,'</div>\n\t</a>\n</a>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["root/home"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="container-fluid home-wrapper">\n  <div class="bg-image"><img src="https://s3-us-west-1.amazonaws.com/thelionsshare/photo-1415889678233-eb900aeee9e1.jpeg"></div>\n  <div class="overlay"></div>\n  <div class="jumbotron">\n    <h1>Let us help you find\n      <br>\n    your share of Brooklyn</h1>\n    <p>\n      <a class="btn btn-lg btn-home" href="#rentals" role="button">Browse Rentals</a>\n      <a class="btn btn-lg btn-home" href="#sales" role="button">Browse Sales</a>\n    </p>\n  </div>\n</div>\n<div class="footer-hover">\n  <div class="browse-footer">\n      <div class="browse-footer-logo col-xs-10 col-sm-6 col-md-6 col-lg-6">\n        <img class="footer-logo-img" src="assets/logo_dark_background.png">\n      </div>\n\n      <div class="browse-copyright footer-terms col-xs-10 col-sm-6 col-md-6 col-lg-6">\n        <p class="terms-copyright">&#169; The Lion\'s Share, Inc. All Rights Reserved. 2015</p>\n      </div>\n    <div class="clear"></div>\n  </div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["root/team_profile"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<div class="broker-profile-header">\n\t<img class="team-member-img" src=', broker.photo_url,'>\n\t<div class="team-member-name">',  broker.first_name ,' ',  broker.last_name ,'</div>\n\t<div class="team-member-phone">',  broker.phone ,'</div>\n\t<div class="team-email">',  broker.email ,'</div>\n</div>\n<div class="broker-listings-container">\n\t<div class="broker-listings-title">',  broker.first_name,'\'s listings</div>\n\t<div class="broker-listings"></div>\n</div>\n<div class="listing-footer">\n  <div class="footer-top">\n    <div class="footer-logo col-xs-10 col-sm-6 col-md-6 col-lg-6">\n      <img class="footer-logo-img" src="assets/logo_dark_background.png">\n    </div>\n    <div class="footer-address col-xs-10 col-sm-6 col-md-6 col-lg-6">\n      <div class="address-title">Location</div>\n      115 S Oxford Street<br>\n      Brooklyn, New York 11217<br>\n      917.909.0526\n    </div>\n    <div class="clear"></div>\n  </div>\n  <div class="footer-bottom">\n  <div class="footer-icons col-xs-10 col-sm-6 col-md-6 col-lg-6">\n    <a class="terms-link" href="#">Terms & Conditions and Privacy Policy</a>\n  </div>\n  <div class="footer-terms col-xs-10 col-sm-6 col-md-6 col-lg-6">\n    <p class="terms-copyright">&#169; The Lion\'s Share, Inc. All Rights Reserved. 2015</p>\n  </div>\n  <div class="clear"></div>\n  </div>\n  <div class="clear"></div>\n</div>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["root/team_view"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<h1>Team</h1>\n<div class="container team">\n  <div class="team-index row row-centered"></div>\n</div>\n<div class="listing-footer">\n  <div class="footer-top">\n    <div class="footer-logo col-xs-10 col-sm-6 col-md-6 col-lg-6">\n      <img class="footer-logo-img" src="assets/logo_dark_background.png">\n    </div>\n    <div class="footer-address col-xs-10 col-sm-6 col-md-6 col-lg-6">\n      <div class="address-title">Location</div>\n      115 S Oxford Street<br>\n      Brooklyn, New York 11217<br>\n      917.909.0526\n    </div>\n    <div class="clear"></div>\n  </div>\n  <div class="footer-bottom">\n  <div class="footer-icons col-xs-10 col-sm-6 col-md-6 col-lg-6">\n    <a class="terms-link" href="#">Terms & Conditions and Privacy Policy</a>\n  </div>\n  <div class="footer-terms col-xs-10 col-sm-6 col-md-6 col-lg-6">\n    <p class="terms-copyright">&#169; The Lion\'s Share, Inc. All Rights Reserved. 2015</p>\n  </div>\n  <div class="clear"></div>\n  </div>\n  <div class="clear"></div>\n</div>\n');}return __p.join('');};
}).call(this);
...
LionsShare.Views.ListingShow = Backbone.CompositeView.extend({
  ...
  addMap: function () {
    ...
    this.map = map;
    var map_pin_img = "/assets/map-pin-unselected-29195976b52296473872b4acfc53f65e7b3c0ee44f6a99ea11787212e16dcfe4.svg";;
...
LionsShare.Views.RentalsIndexView = Backbone.CompositeView.extend({
  ...
  addListingSubview: function (listing) {
    // if (listing.type_of !== "Rental") { return; }
    ...
    this.markers.forEach(function (marker) {
      if ($listing.data('id') == marker.id) {
        ...
        if (view.halfOpacity === true) {
          var map_pin_img = "/assets/map-pin-half-13c5d11d9a43b42a17c3e22129cb1fdf778a682086e69514fb2d775489dfa1c6.png";
        } else {
          var map_pin_img = "/assets/map-pin-selected-5d77eafe31ef1fc2c6d82b478cd589f02a457eca33355dda84c7f886ddc5f261.svg";
        }
  ...
  filterListings: function () {
    ...
    this.listings.fetch({
      ...
      success: function () {
        var num_results = 0;
        // var rentals = new LionsShare.Collections.Listings();
        view.rentals = new LionsShare.Collections.Listings();
        var list = view.listings.first().attributes.listings;
        list.forEach(function (listing) {
          // filter amenities
          ...
          if (listing.type_of == "Rental" && hasAllAmenities === true) {
        ...
        $('.num-results').text(num_results);
        // view.addMapPins(rentals);
        view.addMapPins(view.rentals);
  ...
  //     $dropdown.children().children().each(function (i, childElement) {
  //       if (childElement.id && $(childElement).children()[0].checked) {
  //         if (filterString !== "") {
  //           filterString += ", "
  //           filterString += childElement.id
  //         } else {
  //           filterString += childElement.id
  //         }
  //       }
  //     });
  //   } else {
  //     filterString = '$' + $('.price-min').val() + " to $" + $('.price-max').val();
  //     $dropdown.siblings().parent().parent().css("width", "160px");
  //   }
  //   var $caret = $('<span>').addClass("stay-open caret");
  //   $dropdown.siblings().text(filterString);
  //   $dropdown.siblings().append($caret);
  // },
  ...
  sortByNewest: function (event) {
    ...
    $('.price-sort').removeClass('select-sort');
    var view = this;
    view.rentals.comparator = "updated_at";
    view.rentals.sort();
    var subviews = view.subviews('.matches-wrapper');
    subviews.each(function (subview) {
      subview.remove();
    });
    view.rentals.models.forEach(function (rental) {
...
LionsShare.Routers.Router = Backbone.Router.extend({
  ...
  brokerShow: function (id) {
    var broker = LionsShare.Collections.brokers.getOrFetch(id);
    var view = new LionsShare.Views.BrokerProfileView({
      model: broker
    });
