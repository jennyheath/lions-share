...
LionsShare.Views.SalesIndexView = Backbone.CompositeView.extend({
  ...
  openChecklist: function (event) {
    if ($(event.target).hasClass('toggle-dropdown')) {
